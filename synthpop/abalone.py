...
def main():
    ods = pd.read_csv('abalone.data')
    sds = pd.read_csv('abalone_syn.data')
    header = list(ods)
    ...
    make_tree(ods, header[:-1], "Rings", "abalone_observed")
    make_tree(sds, header[:-1], "Rings", "abalone_synthetic")
